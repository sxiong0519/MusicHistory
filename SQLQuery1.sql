...
VALUES 
	('Replay EP', '05/22/2008', 217, 'SM Entertainment', 30),
	('Hello', '09/30/2010', 2187, 'SM Entertainment', 30),
	('Dont Call Me', '02/22/2001', 2088, 'SM Entertainment', 30);

UPDATE Album
SET ReleaseDate = '02/22/2021'
WHERE Id = 25;

INSERT INTO Song
	(Title, SongLength, ReleaseDate, ArtistId, AlbumId)
VALUES
	('Replay', 217, '05/22/2008', 30, 23),
	('Attention', 258, '02/22/2021', 30, 25),
	('Heart Attack', 222, '02/22/2021', 30, 25),
	('Lucifer', 198, '09/30/2010', 30, 24);

SELECT al.Title as 'Album', s.Title, a.ArtistName
FROM Album al
LEFT JOIN Song s ON al.Id = s.AlbumId
LEFT JOIN Artist a ON s.ArtistId = a.Id
WHERE al.ArtistId = 30; 

SELECT
	COUNT(Id) AS NumSongFromAlbum
FROM Song
GROUP BY Song.AlbumId;

SELECT 
	COUNT(Id) AS NumSongFromArtist
FROM Song
GROUP BY Song.ArtistId;

SELECT 
	COUNT(Id) AS NumSongFromGenre
FROM Song
